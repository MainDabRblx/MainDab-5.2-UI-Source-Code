...
{
	// This is a source code of MainDab dating back to Beta MainDab 5.2 (as it was called at that time).
	// It is nowhere near neat at all, and the only reason the source is now out is for trying to 
	// implement old MainDab features into the current MainDab.
	// Some code has also been fixed, and some features removed.
